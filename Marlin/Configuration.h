...
#define STRING_CONFIG_H_AUTHOR "(Ryan Bahm)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Geeetech A10 GT2560 3.0" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "https://github.com/rdbahm/Marlin/tree/Geeetech-A10"         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Geeetech A10 Actual January 11 2019:
  #define DEFAULT_Kp 16.28
  #define DEFAULT_Ki 2.92
  #define DEFAULT_Kd 22.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.2 }
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 10 - X_PROBE_OFFSET_FROM_EXTRUDER   // Y point for Z homing when homing all axes (G28).
#endif
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.92*2
  #define XY_DIAG_BD 140.77*2
  #define XY_SIDE_AD 41.04*2
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 141*2
    #define XZ_DIAG_BD 140.82*2
